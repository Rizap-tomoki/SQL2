...
35, UPDATE 注文 SET クーポン割引料=クーポン割引料+300 WHERE 注文日>='2018-03-12' AND 注文日<='2018-03-14' AND 数量>=2 AND クーポン割引料 IS NOT NULL 
36, UPDATE 注文 SET 数量=数量-1 WHERE 注文番号='201802250126' AND 商品コード='W0156'
37, SELECT 注文番号 ||'-'|| CASE(注文枝番 AS VARCHAR) FROM 注文 WHERE 注文番号>='201710010001' AND 注文番号<='201710319999'
...
41, SELECT 注文日, SUBSTRING(注文番号,9,4) AS 注文番号 FROM 口座
